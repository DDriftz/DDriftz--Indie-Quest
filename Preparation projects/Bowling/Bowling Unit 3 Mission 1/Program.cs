...
// Mission 1: BOSS LEVEL - Objective: Bowling rules
class BowlingGameMission1
{
    ...
    static void Main()
    {
        ...
        for (int frame = 0; frame < 10; frame++)
        {
            ...
            if (frame < 9 && rolls[frame][0] != 10)
            {
                Console.WriteLine("Press enter to roll!");
                Console.ReadLine();
                int remaining = 10 - rolls[frame][0];
                rolls[frame][1] = rand.Next(0, remaining + 1);
                Console.Clear();
                Console.WriteLine($"FRAME {frame + 1}");
            ...
            else if (frame == 9)
            {
                if (rolls[frame][0] == 10 || rolls[frame][0] + rolls[frame][1] == 10)
                {
                    Console.WriteLine("Press enter to roll!");
                    Console.ReadLine();
                    rolls[frame][1] = rolls[frame][0] == 10 ? rand.Next(0, 11) : rand.Next(0, 11 - rolls[frame][0] + 1);
                    Console.Clear();
                    Console.WriteLine($"FRAME {frame + 1}");
                    Console.WriteLine($"Roll 1: {(rolls[frame][0] == 10 ? "X" : rolls[frame][0].ToString())}");
                    ...
                    Console.WriteLine("Press enter to roll!");
                    Console.ReadLine();
                    rolls[frame][2] = rolls[frame][0] == 10 && rolls[frame][1] == 10 ? rand.Next(0, 11) : rand.Next(0, 11 - (rolls[frame][0] + rolls[frame][1] == 10 ? 0 : rolls[frame][1]) + 1);
                    Console.Clear();
                    Console.WriteLine($"FRAME {frame + 1}");
                    Console.WriteLine($"Roll 1: {(rolls[frame][0] == 10 ? "X" : rolls[frame][0].ToString())}");
                    Console.WriteLine($"Roll 2: {(rolls[frame][0] + rolls[frame][1] == 10 ? "/" : rolls[frame][1] == 10 ? "X" : rolls[frame][1].ToString())}");
